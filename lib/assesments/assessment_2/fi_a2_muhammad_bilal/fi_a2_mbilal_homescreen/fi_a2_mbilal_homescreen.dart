...
class BilalHomeScreen extends StatefulWidget {
  const BilalHomeScreen({Key? key}) : super(key: key);

  @override
  State<BilalHomeScreen> createState() => _BilalHomeScreenState();
}
           ...
           Padding(
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                  radius: 30,
                  backgroundImage: const AssetImage('assets/girl1.png',),
                  child: Image.asset('assets/fi_a2_mbilal_assets/Add.png',width: 20,height: 20,),),
                ...
                Container(
                  ...
                  child: CircleAvatar(
                    ...
                    radius: 30,
                      child: Image.asset(pictures[i],width: 55,height: 55,)),
                  ),
              ],
            ),
          ),
